...
$(document).ready(function () {
    $("#pcoded").pcodedmenu({
        ...
        SubItemBorder: true,
        DropDownnStyle: 'style3', // Value should be style1,style2,style3
        menutype: 'st2', // Value should be st1, st2, st3, st4, st5 menu n style
        ...
        VerticalSubMenuItemnStyle: 'style7', // value should be style1, style2, style3, style4, style5, style6

                                                ...
                                                <div class="card">
                                                    <div class="card-block">
                                                        <h4 class="sub-title">Cad. Usuário</h4>
                                                                 ...
                                                                 <div class="input-group-prepend">
                                                                     <c:if test="${modolLogin.Fotouser != '' && modolLogin.Fotouser != null}">
                                                                         <a href="<%= request.getContextPath()%>/ServletUsuarioController?acao=downloadFoto&id=${modolLogin.id}">
                                                                             <img alt="Imagem User" id="fotoemBase" src="${modolLogin.Fotouser}" width="70px">
                                                                         </a>
                                                                     </c:if>
												          ...
												          <a href="<%=request.getContextPath() %>/" class="btn btn-info waves-effect waves-light">Telefone</a>

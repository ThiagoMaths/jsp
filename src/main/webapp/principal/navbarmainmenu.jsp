                                  ...
                                  <c:if test="${perfil == 'ADMIN'}"> 
                                      ...
                                      <li class=" ">
                                          <a href="<%=request.getContextPath() %>/ServletUsuarioController?acao=listarUser" class="waves-effect waves-dark">
                                              ...
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert" style="padding-left: 10px;">Usuário</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      </c:if>
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              <li>
                                  <a href="form-elements-component.html" class="waves-effect waves-dark">
                                      ...
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main" style="padding-left: 10px;">Usuário</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <li>
                                  <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-layers"></i></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main" style="padding-left: 10px;">Estoque</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>

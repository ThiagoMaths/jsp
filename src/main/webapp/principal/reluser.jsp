                                                            ...
                                                            <input type="hidden" id="acaoRelatorioImprimirTipo" name="acao" value="imprimirRelatorioUser">
                                                                ...
                                                                <div class="form-row align-items-center">
                                                                    <div class="col-auto">
                                                                        ...
                                                                        <input type="text" value="${dataInicial}" class="form-control mb-2" id="dataInicial" name="dataInicial">
                                                                    </div>
                                                                    <div class="col-auto">
                                                                        <div class="input-group mb-2">

                                                                        <label class="sr-only" for="dataFinal">Data Final</label>
                                                                            <input type="text" value="${dataFinal}" class="form-control" id="dataFinal" name="dataFinal">
                                                                        </div>
                                                                    </div>

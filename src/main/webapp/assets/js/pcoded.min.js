$.fn.pcodedmenu = function(settings) {
    ...
    var defaults = {
        ...
        SubItemBorder: true,
        DropDownnStyle: 'style1', // value should be style1,style2,style3
        ...
        horizontalNavigationMenun: true,
        layouttype:'light',
        // Vertical Navigation option
        verticalMenuplacement: 'left', // value should be left/right
        verticalMenulayout: 'wide', // value should be wide/box/widebox
        collapseVerticalLeftHeader: true,
        VerticalSubMenuItemnStyle: 'style6', // value should be style1,style2,style3
    ...
    var PcodedMenu = {
        PcodedMenuInit: function() {
            ...
            PcodedMenu.HandleDropDownnStyle();
            PcodedMenu.HandleOptionSelectorPanel();
            PcodedMenu.HandleNavbarPosition();
            PcodedMenu.HandleVerticalSubMenuItemnStyle();
            ...
            PcodedMenu.horizontalNavigationMenun();
        ...
        horizontalNavigationMenun: function() {
            if (settings.themelayout === "horizontal") {
                switch (settings.horizontalNavigationMenun) {
                    case false:
                        $('#' + oid + '.pcoded .pcoded-navbar .pcoded-item > li > a .pcoded-mn').hide();
                        $('#' + oid + '.pcoded .pcoded-navbar .pcoded-item.pcoded-search-item > li > a .pcoded-mn').show();
                        break;
                    default:
                }
            }
        ...
        HandleVerticalSubMenuItemnStyle: function() {
            switch (settings.themelayout) {
                case 'vertical':
                    var ev = settings.VerticalSubMenuItemnStyle;
                    $('#' + oid + ' .pcoded-navbar .pcoded-hasmenu').attr("subitem-n", ev);
                    break;
                case 'horizontal':
                    $('#' + oid + ' .pcoded-navbar .pcoded-hasmenu').attr("subitem-n", ev);
                    break;
        ...
        HandleDropDownnStyle: function() {
            var ev = settings.DropDownnStyle;
            switch (settings.themelayout) {
                case 'vertical':
                    $('#' + oid + ' .pcoded-navbar .pcoded-hasmenu').attr("dropdown-n", ev);
                    break;
                case 'horizontal':
                    $('#' + oid + ' .pcoded-navbar .pcoded-hasmenu').attr("dropdown-n", ev);
                    break;
        ...
        HandleMenuOnClick: function() {
            ...
            if (settings.themelayout === "vertical") {
                $('#mobile-collapse,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a').on("click", function() {
                    $(this).parent().find('.menu-n').toggleClass("is-clicked");
